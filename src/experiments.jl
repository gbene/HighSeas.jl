...
struct Experiment{F<:AbstractArray{Float64}, M<:AbstractMaterial, D<:AbstractDomain, S<:AbstractState, C<: AbstractCatalog} <: AbstractExperiment
    ...
    function Experiment(input_dict::Dict, material::M, domain::D, n_events, output_dir::String; gpu_id::Int=0) where {M, D}
    ...
    function Experiment(input_dict::Dict, material::M, domain::D, n_events, output_dir::String, loadedstep::LoadedStep; gpu_id::Int=0) where {M, D}
    ...
    function Experiment{F, M, D, S, C}(material::M, domain::D, start_time, outpath,
                        Vpl, Vr, Vi, lengthscales,
                        a::F, b::F, tau0::F, si0::F,
                        state_init::S, catalog_init::C) where {F, M, D, S, C}
